...
//                            shangpinOrderEntity.setQuwuTypes(Integer.valueOf(data.get(0)));   //取物类型 要改的
...
//                            shangpinOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody ShangpinOrderEntity shangpinOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,shangpinOrder:{}",this.getClass().getName(),shangpinOrder.toString());
            ...
            YonghuEntity yonghuEntity2 = yonghuService.selectById(shangpinEntity.getYonghuId());
        yonghuEntity2.setNewMoney(yonghuEntity2.getNewMoney()+shangpinOrder.getShangpinOrderTruePrice());//动态计算金额
            yonghuService.updateById(yonghuEntity2);
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer addressId = Integer.valueOf(String.valueOf(params.get("addressId")));
            ...
            Integer quwuTypes = Integer.valueOf(String.valueOf(params.get("quwuTypes")));//取物类型
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            ...
            shangpinOrderEntity.setQuwuTypes(quwuTypes);//取物类型 ？？？？？？
    ...
    */
    ...
    public R receiving(Integer id , HttpServletRequest request){
        ...
        if(shangpinEntity.getShangpinKucunNumber() < 0){
